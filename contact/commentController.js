...
function getData() {
    ...
    let x = document.getElementById("contactForm").elements[2].value;
    let y = document.getElementById("contactForm").elements[3].value;
    let z = document.getElementById("contactForm").elements[4].value;
    ...
    displayMessages("comment", "commentOutput")
}
